#ifndef __RTC_HTTPFILEMGR_H__
#define __RTC_HTTPFILEMGR_H__
...
@protocol RTCHttpFileMgrCallBack <NSObject>
@optional
...
CRVSDK_EXPORT
@interface RTCHttpFileMgr : NSObject

// 获取单例对象
+ (RTCHttpFileMgr *)shareInstance;
...
// 设置回调
- (void)setHttpFileMgrCallback:(id <RTCHttpFileMgrCallBack>)callBack;
- (void)registerHttpFileMgrCallback:(id <RTCHttpFileMgrCallBack>)callBack;

- (void)removeHttpFileMgrCallback:(id <RTCHttpFileMgrCallBack>)callBack;
