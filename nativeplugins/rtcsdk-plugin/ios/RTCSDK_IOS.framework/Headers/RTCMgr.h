#ifndef __RTC_MGR_H__
#define __RTC_MGR_H__
#import <Foundation/Foundation.h>
#import <CoreGraphics/CGGeometry.h>
#include <RTCSDK_IOS/RTCQueue.h>
#include <RTCSDK_IOS/RTCSDK_Def.h>
#include <RTCSDK_IOS/RTCCommonType.h>
...
@protocol RTCMgrCallBack <NSObject>
@optional
...
/**
 ...
 @param callBack 代理对象
 */
- (void)setMgrCallback:(id <RTCMgrCallBack>)callBack;

/**
 注册回调
 @param callBack 代理对象
 */
- (void)registerMgrCallback:(id <RTCMgrCallBack>)callBack;

/**
 移除回调
 @param callBack 代理对象
 */
-(void) removeMgrCallback:(id<RTCMgrCallBack>)callBack;
