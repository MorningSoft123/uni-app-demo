#ifndef __RTCQUEUE_H__
#define __RTCQUEUE_H__
...
@protocol RTCQueueCallBack <NSObject>
@optional
/**
 初始化队列回调
...
/**
 ...
 @param callBack 代理对象
 */
- (void)setQueueCallback:(id <RTCQueueCallBack>)callBack;

/**
 注册回调
 @param callBack 代理对象
 */
- (void)registerQueueCallback:(id <RTCQueueCallBack>)callBack;

/**
 移除回调
 @param callBack 移除多代理模式代理对象
 */
- (void)removeQueueCallback:(id <RTCQueueCallBack>)callBack;
